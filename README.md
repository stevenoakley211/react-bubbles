...
Its used to id a user and authenticate who they are
- [ ] What steps can you take in your web apps to keep your data secure?
store a token in memory so that a user has to login whenever they leave the page, or use a time based token that after issued expires after a set amount of time.
...
put is the update part of crud and delete is the d
